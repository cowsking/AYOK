...
def analyze_health_data(message: str) -> str:
    ...
    model="gpt-4o",
    messages=[
        {"role": "system", "content": "You are a mental health counselor. Based on several days of data from the user, please provide emotional support to them. here is the data: "+str(health_data)},
        {
            "role": "user",
            "content": message
        }
